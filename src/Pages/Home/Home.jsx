      ...
      {!data || !flowerPlants || !instoments || loading || error !== null ? (
        ...
        <div>
          ...
          <div data-aos="zoom-in-down" data-aos-delay="50" className="md:my-6">
            <h3 className="text-3xl font-bold">
              Required <span className="text-green-500">Instruments</span> For
              You
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-2">
            ...
            <div className="collapse collapse-arrow bg-base-200">
              ...
              <div className="collapse-content">
                <p>
                  ...
                  ea dolore repellendus sunt quam nihil officia, eaque, eveniet
                  deleniti iure illum quasi maxime iusto hic magni eius
                  laudantium voluptates ipsum.
                </p>
              </div>
            </div>
            <div className="collapse collapse-arrow bg-base-200">
